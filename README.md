...
# This repo contains week 1  Toy assigments 

# --------------------------------------------------------------------------------------------------------------------

# Title: Student Grade Generator (Toy Problem)
...
# open file named grade_gen.js with your browser
# Enter student's mark in the prompt (number between 0 and 100)
# Press ENTER key and the student's grade will be generated.
# PLEASE NOTE: Marks should be a number between 0 and 100

# ---------------------------------------------------------------------------------------------------------------------

# Title: Speed Detector (Toy Problem)
